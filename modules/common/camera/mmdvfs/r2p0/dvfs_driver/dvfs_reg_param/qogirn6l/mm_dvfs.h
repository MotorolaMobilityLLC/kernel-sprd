...
enum {
	MM_MTX_CLK_INDEX_1536 = 0, //153.6
	MM_MTX_CLK_INDEX_2560 = 1, //256
	MM_MTX_CLK_INDEX_3072 = 2, //307.2
	MM_MTX_CLK_INDEX_4096 = 3, //409.6
	MM_MTX_CLK_INDEX_5120 = 4, //512
};
...
#define DVFS_VERSION_N6L 0x0502
