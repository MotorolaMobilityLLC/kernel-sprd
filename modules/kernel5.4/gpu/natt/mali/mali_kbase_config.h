...
struct kbase_pm_callback_conf {
	...
	/* Sprd callback invoked to enable/disable dcdc_gpu*/
	void (*power_off_second_part_callback)(struct kbase_device *kbdev);
	void (*power_on_first_part_callback)(struct kbase_device *kbdev);

	/* Sprd callback invoked to clear dcdc_gpu_poweron_in_progress*/
	void (*power_on_clear_flag_callback)(struct kbase_device *kbdev);
};
