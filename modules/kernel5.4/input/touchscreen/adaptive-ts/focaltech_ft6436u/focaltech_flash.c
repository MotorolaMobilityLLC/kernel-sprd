...
#define FTS_FW_NAME_PREX_WITH_REQUEST               "A631W_DJ6831B_FT6436U"
...
#endif
const u8 fts_fw_data_buf0[]={
    #include "DJ6831B-A631W-6436U-480x1014_Ver0x06_20220308_app.i"
    };
...
#else
    memcpy(fw_data, fts_fw_data_buf0, ntv_dts_data.tpd_firmware_size[upg->ts_data->vendor_num]);
#endif
