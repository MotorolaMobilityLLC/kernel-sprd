...
void fts_set_chip_info(struct fts_ts_data *ts_data)
{
    ...
    {
        ts_data->ic_info.is_incell = ((_FT6436U & FLAGBIT(FLAG_IDC_BIT)) == FLAGBIT(FLAG_IDC_BIT));
        ts_data->ic_info.hid_supported = ((_FT6436U & FLAGBIT(FLAG_HID_BIT)) == FLAGBIT(FLAG_HID_BIT));
    }
