...
struct sprd_cpu_cluster_info {
	...
	int temp_list[TEMP_THRESHOLD_NUM];
	...
	int cpu_bin, max_cpu_bin, min_vol;
	char *cpubin_str;
	unsigned int temp_max_freq;
	u32 slave_cluster_count;
	struct slave_cluster_info *slave_cluster;
