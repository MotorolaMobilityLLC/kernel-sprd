...
#define SPRD_SEND_CLOSE				14
#define SPRD_CMD_TX_DATA			15
#define SPRD_WORK_FW_PWR_DOWN			16
#define SPRD_WORK_HOST_WAKEUP_FW		17
#define SPRD_WORK_VOWIFI_DATA_PROTECTION	18
#define SPRD_PCIE_RX_ALLOC_BUF			19
