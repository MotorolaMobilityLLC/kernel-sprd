...
enum sprdwl_vendor_attribute {
	...
	SPRDWL_VENDOR_AFTER_LAST,
	SPRDWL_VENDOR_MAX =
		SPRDWL_VENDOR_AFTER_LAST - 1,
};

static const struct nla_policy
	roaming_policy[SPRDWL_VENDOR_MAX + 1] = {
	[SPRDWL_VENDOR_ROAMING_POLICY] = {.type = NLA_U32},
};
...
enum sprdwl_wlan_vendor_attr_ll_stats_type {
	SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_INVALID = 0,
	SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_RADIO = 1,
	SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_IFACE = 2,
	SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_PEERS = 3,
...
static const struct
nla_policy ll_stats_get_policy[SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_TYPE_MAX + 1] = {
		[SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_RADIO] = {.type = NLA_U32},
		[SPRDWL_NL80211_VENDOR_SUBCMD_LL_STATS_GET_TYPE_IFACE] = {.type = NLA_U32},
};
...
static const struct
nla_policy ll_stats_clr_policy[SPRDWL_LL_STATS_CLR_MAX + 1] = {
		[SPRDWL_LL_STATS_CLR_CONFIG_REQ_MASK] = {.type = NLA_U32},
		[SPRDWL_LL_STATS_CLR_CONFIG_STOP_REQ] = {.type = NLA_U8},
		[SPRDWL_LL_STATS_CLR_CONFIG_RSP_MASK] = {.type = NLA_U32},
		[SPRDWL_LL_STATS_CLR_CONFIG_STOP_RSP] = {.type = NLA_U32},
};
...
static const struct nla_policy
	...
	[GSCAN_ATTR_GET_VALID_CHANNELS_CONFIG_PARAM_WIFI_BAND] = {.type = NLA_U32},
	[GSCAN_ATTR_GET_VALID_CHANNELS_CONFIG_PARAM_MAX_CHANNELS] = {.type = NLA_U32},
	...
	[GSCAN_ATTR_BUCKET_SPEC_MAX_PERIOD] = {.type = NLA_U32},
	[GSCAN_ATTR_BUCKET_SPEC_BASE] = {.type = NLA_U32},
	[GSCAN_ATTR_BUCKET_SPEC_STEP_COUNT] = {.type = NLA_U32},
	[GSCAN_ATTR_CHANNEL_SPEC] = {.type = NLA_U32},
	...
	[GSCAN_ATTR_SCAN_CMD_PARAMS_REPORT_THR_NUM_SCANS] = {.type = NLA_U8},
	[GSCAN_ATTR_SCAN_CMD_PARAMS_NUM_BUCKETS] = {.type = NLA_U8},
	[GSCAN_ATTR_BUCKET_SPEC] = {.type = NLA_NESTED},
	[GSCAN_ATTR_GET_CACHED_SCAN_RESULTS_CONFIG_PARAM_FLUSH] = {.type = NLA_U8},
	[GSCAN_ATTR_GET_CACHED_SCAN_RESULTS_CONFIG_PARAM_MAX] = {.type = NLA_U32},
	...
	[GSCAN_ATTR_AP_THR_PARAM] = {.type = NLA_NESTED},
	[GSCAN_ATTR_SIGNIFICANT_CHANGE_PARAMS_RSSI_SAMPLE_SIZE] = {.type = NLA_U32},
	[GSCAN_ATTR_SIGNIFICANT_CHANGE_PARAMS_LOST_AP_SAMPLE_SIZE] = {.type = NLA_U32},
	[GSCAN_ATTR_SIGNIFICANT_CHANGE_PARAMS_MIN_BREACHING] = {.type = NLA_U32},
	[GSCAN_ATTR_SIGNIFICANT_CHANGE_PARAMS_NUM_AP] = {.type = NLA_U32},
	[GSCAN_ATTR_BSSID_HOTLIST_PARAMS_LOST_AP_SAMPLE_SIZE] = {.type = NLA_U32},
	[GSCAN_ATTR_GSCAN_SSID_HOTLIST_PARAMS_LOST_SSID_SAMPLE_SIZE] = {.type = NLA_S32},
	[GSCAN_ATTR_GSCAN_SSID_HOTLIST_PARAMS_NUM_SSID] = {.type = NLA_S32},
	[GSCAN_ATTR_GSCAN_SSID_THR_PARAM] = {.type = NLA_NESTED},
};
...
static const struct nla_policy
	mac_oui_policy[WLAN_VENDOR_ATTR_SET_SCANNING_MAC_OUI_MAX + 1] = {
	[WLAN_VENDOR_ATTR_SET_SCANNING_MAC_OUI] = { .type = NLA_BINARY, .len = 3},
};
...
static const struct
nla_policy get_concurrency_matrix_policy[SPRDWL_ATTR_CO_MATRIX_MAX + 1] = {
	[SPRDWL_ATTR_CO_MATRIX_CONFIG_PARAM_SET_SIZE_MAX] = {.type = NLA_U32},
};
...
static const struct
nla_policy get_wifi_info_policy[SPRDWL_ATTR_WIFI_INFO_GET_MAX + 1] = {
...
enum vendor_attr_wifi_logger_start {
	SPRDWL_ATTR_WIFI_LOGGER_START_INVALID = 0,
	SPRDWL_ATTR_WIFI_LOGGER_RING_ID = 1,
	SPRDWL_ATTR_WIFI_LOGGER_VERBOSE_LEVEL = 2,
	SPRDWL_ATTR_WIFI_LOGGER_FLAGS = 3,

	/* keep last */
	SPRDWL_ATTR_WIFI_LOGGER_START_AFTER_LAST,
	SPRDWL_ATTR_WIFI_LOGGER_START_GET_MAX =
		SPRDWL_ATTR_WIFI_LOGGER_START_AFTER_LAST - 1,
};

static const struct
nla_policy wifi_logger_start_policy[SPRDWL_ATTR_WIFI_LOGGER_START_GET_MAX + 1] = {
	[SPRDWL_ATTR_WIFI_LOGGER_RING_ID] = {.type = NLA_U32},
	[SPRDWL_ATTR_WIFI_LOGGER_VERBOSE_LEVEL] = {.type = NLA_U32},
	[SPRDWL_ATTR_WIFI_LOGGER_FLAGS] = {.type = NLA_U32},
};
...
static const struct nla_policy roaming_config_policy[SPRDWL_ROAM_MAX + 1] = {
		[SPRDWL_ROAM_SUBCMD] = {.type = NLA_U32},
		[SPRDWL_ROAM_REQ_ID] = {.type = NLA_U32},
		[SPRDWL_ROAM_WHITE_LIST_SSID_NUM_NETWORKS] = {.type = NLA_U32},
		[SPRDWL_ROAM_WHITE_LIST_SSID_LIST] = {.type = NLA_NESTED},
		[SPRDWL_ROAM_WHITE_LIST_SSID] = {.type = NLA_BINARY},
		[SPRDWL_ROAM_SET_BSSID_PARAMS] = {.type = NLA_NESTED},
		[SPRDWL_ROAM_SET_BSSID_PARAMS_NUM_BSSID] = {.type = NLA_U32},
		[SPRDWL_ROAM_SET_BSSID_PARAMS_BSSID] = {.type = NLA_BINARY},
};
...
static const struct
nla_policy roam_policy[SPRDWL_ATTR_ROAM_SUBCMD_MAX + 1] = {
		[SPRDWL_ATTR_ROAM_SUBCMD_SSID_WHITE_LIST] = {.type = NLA_U32},
		[SPRDWL_ATTR_ROAM_SUBCMD_SET_GSCAN_ROAM_PARAMS] = {.type = NLA_U32},
		[SPRDWL_ATTR_ROAM_SUBCMD_SET_LAZY_ROAM] = {.type = NLA_U32},
		[SPRDWL_ATTR_ROAM_SUBCMD_SET_BSSID_PREFS] = {.type = NLA_U32},
		[SPRDWL_ATTR_ROAM_SUBCMD_SET_BSSID_PARAMS] = {.type = NLA_U32},
		[SPRDWL_ATTR_ROAM_SUBCMD_SET_BLACKLIST_BSSID] = {.type = NLA_U32},
};
...
static const struct nla_policy rssi_monitoring_policy[SPRDWL_ATTR_RSSI_MONITORING_MAX + 1] = {
	[SPRDWL_ATTR_RSSI_MONITORING_REQUEST_ID] = {.type = NLA_U32},
	[SPRDWL_ATTR_RSSI_MONITORING_CONTROL] = {.type = NLA_U32},
	[SPRDWL_ATTR_RSSI_MONITORING_MIN_RSSI] = {.type = NLA_S8},
	[SPRDWL_ATTR_RSSI_MONITORING_MAX_RSSI] = {.type = NLA_S8},
};

/*RSSI monitor End*/

enum vendor_attr_nd_offload {
	SPRDWL_ATTR_ND_OFFLOAD_INVALID = 0,
	SPRDWL_ATTR_ND_OFFLOAD_FLAG,
	SPRDWL_ATTR_ND_OFFLOAD_AFTER_LAST,
	SPRDWL_ATTR_ND_OFFLOAD_MAX =
		SPRDWL_ATTR_ND_OFFLOAD_AFTER_LAST - 1,
};

static const struct nla_policy nd_offload_policy[SPRDWL_ATTR_ND_OFFLOAD_MAX + 1] = {
	[SPRDWL_ATTR_ND_OFFLOAD_FLAG] = {.type = NLA_U8},
};
...
static const struct
nla_policy wake_stats_policy[WLAN_GET_WAKE_STATS_MAX + 1] = {
	[WLAN_ATTR_CMD_EVENT_WAKE_CNT_SZ] = { .type = NLA_U32 },
	[WLAN_ATTR_DRIVER_FW_LOCAL_WAKE_CNT_SZ] = { .type = NLA_U32 },
};
...
static const struct
nla_policy vendor_sar_limits_policy[WLAN_ATTR_SAR_LIMITS_MAX + 1] = {
	[WLAN_ATTR_SAR_LIMITS_SAR_ENABLE] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_NUM_SPECS] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_SPEC] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_SPEC_BAND] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_SPEC_CHAIN] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_SPEC_MODULATION] = { .type = NLA_U32 },
	[WLAN_ATTR_SAR_LIMITS_SPEC_POWER_LIMIT] = { .type = NLA_U32 },
};
...
static const struct nla_policy
	wlan_gscan_result_policy[SPRD_WLAN_VENDOR_ATTR_PNO_MAX + 1] = {
	[GSCAN_RESULTS_REQUEST_ID] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_LIST_PARAM_NUM] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_LIST_PARAM_NETWORK_ARRAY] = {.type = NLA_NESTED},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_NETWORK_PARAM_ID] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_NETWORK_PARAM_REALM] = {.type = NLA_STRING},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_NETWORK_PARAM_ROAM_CNSRTM_ID] = {.type = NLA_BINARY},
	[SPRD_WLAN_VENDOR_ATTR_PNO_PASSPOINT_NETWORK_PARAM_ROAM_PLMN] = {.type = NLA_BINARY},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_MIN5GHZ_RSSI] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_MIN24GHZ_RSSI] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_INITIAL_SCORE_MAX] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_CURRENT_CONNECTION_BONUS] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_SAME_NETWORK_BONUS] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_SECURE_BONUS] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_EPNO_BAND5GHZ_BONUS] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_PNO_SET_LIST_PARAM_NUM_NETWORKS] = {.type = NLA_U32},
	[SPRD_WLAN_VENDOR_ATTR_PNO_SET_LIST_PARAM_EPNO_NETWORKS_LIST] = {.type = NLA_NESTED},
	[SPRD_WLAN_VENDOR_ATTR_PNO_SET_LIST_PARAM_EPNO_NETWORK_SSID] = {.type = NLA_BINARY,
							   .len = IEEE80211_MAX_SSID_LEN},
	[SPRD_WLAN_VENDOR_ATTR_PNO_SET_LIST_PARAM_EPNO_NETWORK_FLAGS] = {.type = NLA_U8},
	[SPRD_WLAN_VENDOR_ATTR_PNO_SET_LIST_PARAM_EPNO_NETWORK_AUTH_BIT] = {.type = NLA_U8},
};

enum qca_wlan_vendor_attr_get_logger_features {
	SPRDWL_ATTR_LOGGER_INVALID = 0,
	SPRDWL_ATTR_LOGGER_SUPPORTED = 1,
	/* keep last */
	SPRDWL_ATTR_LOGGER_AFTER_LAST,
	SPRDWL_ATTR_LOGGER_MAX =
		SPRDWL_ATTR_LOGGER_AFTER_LAST - 1,
};

static const struct nla_policy
	get_logger_features_policy[SPRDWL_ATTR_LOGGER_MAX + 1] = {
	[SPRDWL_ATTR_LOGGER_SUPPORTED] = {.type = NLA_U32},
};
...
enum sprdwl_softap_sae_type {
	...
	SPRDWL_VENDOR_SAE_MAX =
	    SPRDWL_VENDOR_SAE_PWD,
};
...
static const struct
nla_policy offloaded_packets_policy[OFFLOADED_PACKETS_MAX + 1] = {
	[OFFLOADED_PACKETS_SENDING_CONTROL] = { .type = NLA_U32 },
	[OFFLOADED_PACKETS_REQUEST_ID] = { .type = NLA_U32 },
	[OFFLOADED_PACKETS_IP_PACKET_DATA] = { .type = NLA_BINARY },
	[OFFLOADED_PACKETS_SRC_MAC_ADDR] = { .type = NLA_BINARY, .len = ETH_ALEN },
	[OFFLOADED_PACKETS_DST_MAC_ADDR] = { .type = NLA_BINARY, .len = ETH_ALEN },
	[OFFLOADED_PACKETS_PERIOD] = { .type = NLA_U32 },
	[OFFLOADED_PACKETS_ETHER_PROTO_TYPE] = { .type = NLA_U16 },
};
