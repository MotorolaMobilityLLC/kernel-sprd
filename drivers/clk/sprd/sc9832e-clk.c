...
static struct sprd_clk_common *sc9832e_pmu_apb_clks[] = {
...
static struct clk_hw_onecell_data sc9832e_pmu_apb_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_pmu_apb_desc = {
	.clk_clks	= sc9832e_pmu_apb_clks,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_pmu_apb_clks),
	.hw_clks        = &sc9832e_pmu_apb_hws,
};

static const u64 itable[4] = {3, 936000000, 1248000000, 1600000000};
...
static struct sprd_clk_common *sc9832e_anlg_phy_g1_clks[] = {
...
static struct clk_hw_onecell_data sc9832e_anlg_phy_g1_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_anlg_phy_g1_desc = {
	.clk_clks	= sc9832e_anlg_phy_g1_clks,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_anlg_phy_g1_clks),
	.hw_clks        = &sc9832e_anlg_phy_g1_hws,
};
...
static struct sprd_clk_common *sc9832e_anlg_phy_g2_clks[] = {
	/* address base is 0x403d0000 */
	&dpll_clk.common,

};

static struct clk_hw_onecell_data sc9832e_anlg_phy_g2_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_anlg_phy_g2_desc = {
	.clk_clks	= sc9832e_anlg_phy_g2_clks,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_anlg_phy_g2_clks),
	.hw_clks        = &sc9832e_anlg_phy_g2_hws,
};
...
static struct sprd_clk_common *sc9832e_anlg_phy_g4_clks[] = {
	/* address base is 0x403f0000 */
	&mpll_clk.common,

};

static struct clk_hw_onecell_data sc9832e_anlg_phy_g4_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_anlg_phy_g4_desc = {
	.clk_clks	= sc9832e_anlg_phy_g4_clks,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_anlg_phy_g4_clks),
	.hw_clks        = &sc9832e_anlg_phy_g4_hws,
};
...
static struct sprd_clk_common *sc9832e_anlg_phy_g6_clks[] = {
...
static struct clk_hw_onecell_data sc9832e_anlg_phy_g6_hws = {
	.hws	= {
	...
	.num	= CLK_ANLG_PHY_G6_NUM,
};

static const struct sprd_clk_desc sc9832e_anlg_phy_g6_desc = {
	.clk_clks	= sc9832e_anlg_phy_g6_clks,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_anlg_phy_g6_clks),
	.hw_clks        = &sc9832e_anlg_phy_g6_hws,
};
...
static struct sprd_clk_common *sc9832e_ap_ahb_gate[] = {
...
static struct clk_hw_onecell_data sc9832e_ap_ahb_gate_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_ap_ahb_gate_desc = {
	.clk_clks	= sc9832e_ap_ahb_gate,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_ap_ahb_gate),
	.hw_clks	= &sc9832e_ap_ahb_gate_hws,
};
...
static SPRD_COMP_CLK(aux0_clk,	"aux0",		aux_parents, 0x88,
		     0, 1, 16, 4, 0);
static SPRD_COMP_CLK(aux1_clk,	"aux1",		aux_parents, 0x88,
		     4, 1, 20, 4, 0);

static struct sprd_clk_common *sc9832e_aon_apb[] = {
	/* address base is 0x402e0000 */
	&aux0_clk.common,
	&aux1_clk.common,
};

static struct clk_hw_onecell_data sc9832e_aon_apb_hws = {
	.hws	= {
...
static const struct sprd_clk_desc sc9832e_aon_prediv_desc = {
	.clk_clks	= sc9832e_aon_apb,
	.num_clk_clks	= ARRAY_SIZE(sc9832e_aon_apb),
	.hw_clks	= &sc9832e_aon_apb_hw,
};
#endif
...
static const struct of_device_id sprd_sc9832e_clk_ids[] = {
	{ .compatible = "sprd,sc9832e_pmu_apb",		/* 0x402b0000 */
	  .data = &sc9832e_pmu_apb_desc },
	{ .compatible = "sprd,sc9832e_anlg_phy_g1",	/* 0x403c0000 */
	  .data = &sc9832e_anlg_phy_g1_desc },
	{ .compatible = "sprd,sc9832e_anlg_phy_g2",	/* 0x403d0000 */
	  .data = &sc9832e_anlg_phy_g2_desc },
	{ .compatible = "sprd,sc9832e_anlg_phy_g4",	/* 0x403f0000 */
	  .data = &sc9832e_anlg_phy_g4_desc },
	{ .compatible = "sprd,sc9832e_anlg_phy_g6",	/* 0x40410000 */
	  .data = &sc9832e_anlg_phy_g6_desc },
	{ .compatible = "sprd,sc9832e_ap_clk",		/* 0x21500000 */
	  .data = &sc9832e_ap_clk_desc },
	{ .compatible = "sprd,sc9832e_aon_prediv",	/* 0x402d0000 */
	  .data = &sc9832e_aon_prediv_desc },
	{ .compatible = "sprd,sc9832e_ap_ahb",		/* 0x20e00000 */
	  .data = &sc9832e_ap_ahb_gate_desc },
	{ }
};
