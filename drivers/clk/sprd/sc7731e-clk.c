...
static const char * const pwm_parents[] = { "clk-32k", "ext-26m-cp",
					"ext-26m", "cpll-40m",
					"twpll-48m" };
...
static const char * const nandc_parents[] = { "ext-1m", "ext-26m",
...
static const char * const emmc_parents[] = { "ext-1m", "ext-26m",
					"twpll-307m2", "twpll-384m",
					"cpll-400m", "bbpll-416m" };
