...
static struct sprd_reset_map ums312_pmu_apb_resets[] = {
...
static struct sprd_clk_desc ums312_pmu_gate_desc = {
	...
	.resets		= ums312_pmu_apb_resets,
	.num_resets	= ARRAY_SIZE(ums312_pmu_apb_resets),
};
...
static struct sprd_reset_map ums312_ap_ahb_resets[] = {
...
static struct sprd_clk_desc ums312_apahb_gate_desc = {
	...
	.resets		= ums312_ap_ahb_resets,
	.num_resets	= ARRAY_SIZE(ums312_ap_ahb_resets),
};
...
static struct sprd_reset_map ums312_aon_ahb_resets[] = {
...
static struct sprd_clk_desc ums312_aon_gate_desc = {
	...
	.resets		= ums312_aon_ahb_resets,
	.num_resets	= ARRAY_SIZE(ums312_aon_ahb_resets),
};
...
static struct sprd_reset_map ums312_audcp_apb_resets[] = {
...
static const struct sprd_clk_desc ums312_audcpapb_gate_desc = {
	...
	.resets		= ums312_audcp_apb_resets,
	.num_resets	= ARRAY_SIZE(ums312_audcp_apb_resets),
};
...
static struct sprd_reset_map ums312_audcp_ahb_resets[] = {
	[RESET_AUDCP_AHB_VBS_24M_SOFT_RST]	= { 0x0008, BIT(0), 0x100 },
...
static const struct sprd_clk_desc ums312_audcpahb_gate_desc = {
	...
	.resets		= ums312_audcp_ahb_resets,
	.num_resets	= ARRAY_SIZE(ums312_audcp_ahb_resets),
};
...
static struct sprd_reset_map ums312_gpu_apb_resets[] = {
...
static struct sprd_clk_desc ums312_gpu_clk_desc = {
	...
	.resets		= ums312_gpu_apb_resets,
	.num_resets	= ARRAY_SIZE(ums312_gpu_apb_resets),
};
...
static struct sprd_reset_map ums312_mm_ahb_resets[] = {
	...
	[RESET_MM_AHB_DCAM_AXIM_SOFT_RST]	= { 0x0004, BIT(6), 0x1000 },
	...
	[RESET_MM_AHB_ISP_AXI_SOFT_RST]		= { 0x0004, BIT(11), 0x1000 },
	...
	[RESET_MM_AHB_DCAM_SOFT_RST_MASK]	= { 0x0004, BIT(20), 0x1000 },
	[RESET_MM_AHB_ISP_DCAM1_SOFT_RST]	= { 0x0004, BIT(21), 0x1000 },
	[RESET_MM_AHB_ISP_DCAM0_SOFT_RST]	= { 0x0004, BIT(22), 0x1000 },
...
static struct sprd_clk_desc ums312_mm_gate_clk_desc = {
	...
	.resets		= ums312_mm_ahb_resets,
	.num_resets	= ARRAY_SIZE(ums312_mm_ahb_resets),
};
...
static struct sprd_reset_map ums312_ap_apb_resets[] = {
...
static struct sprd_clk_desc ums312_apapb_gate_desc = {
	...
	.resets		= ums312_ap_apb_resets,
	.num_resets	= ARRAY_SIZE(ums312_ap_apb_resets),
};
