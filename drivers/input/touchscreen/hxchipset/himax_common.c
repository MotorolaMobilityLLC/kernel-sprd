...
static void himax_boot_upgrade(struct work_struct *work)
{
	...
	hxfw = NULL;
        ...
        if (strstr(lcd_name, "hx83102") != NULL) {
                snprintf(lcdname, sizeof(lcdname), "youda-hx83102d");
                snprintf(vendor_name, sizeof(vendor_name), "youda-hx83102d");
                snprintf(version, sizeof(version),"FW:%02x_%02x,VID:0xA2", ic_data->vendor_touch_cfg_ver,ic_data->vendor_display_cfg_ver);
        }
#endif
