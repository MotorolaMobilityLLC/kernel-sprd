...
//---I2C driver info.---
#define NVT_I2C_NAME "[TS] NVT-ts"
#define I2C_BLDR_Address 0x01
#define I2C_FW_Address 0x01
#define I2C_HW_Address 0x62

#if NVT_DEBUG
#define NVT_LOG(fmt, args...)    pr_err("[%s] %s: " fmt, NVT_I2C_NAME, __func__, ##args)
#else
#define NVT_LOG(fmt, args...)    pr_info("[%s] %s: " fmt, NVT_I2C_NAME, __func__, ##args)
#endif
#define NVT_ERR(fmt, args...)    pr_err("[%s] %s: " fmt, NVT_I2C_NAME, __func__, ##args)

//---Input device info.---
#define NVT_TS_NAME "nt36xxx_touch"
...
//---extern functions---
extern int32_t nvt_ctp_i2c_read(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
extern int32_t nvt_ctp_i2c_write(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
...
extern int nvt_get_tpd_firmware(struct i2c_client *client);
...
extern int Boot_Update_Firmware(void);
