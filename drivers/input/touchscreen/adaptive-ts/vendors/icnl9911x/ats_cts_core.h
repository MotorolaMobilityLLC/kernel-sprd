...
enum cts_firmware_cmd {
    ...
    CTS_CMD_PROXI_EN  = 0xA0,
    CTS_CMD_PROXI_DISABLE = 0xA1,
};
...
extern struct device *g_cts_dev;
...
extern void cts_init_rtdata_with_normal_mode(struct cts_device *cts_dev);
extern int cts_probe_device_ext(struct cts_device *cts_dev);
extern int cts_get_touchinfo_ext(const struct cts_device *cts_dev,
        struct cts_device_touch_info *touch_info);
extern int  incl9911x_upgrade_init(void);
extern int g_fw_control_icnl;
extern u8 g_ps_state_old;
