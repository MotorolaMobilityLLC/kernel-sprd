...
#define CFG_CTS_DRIVER_VERSION              "v1.4.0"

/** Whether reset pin is used */
#define CFG_CTS_HAS_RESET_PIN

#if defined( CONFIG_TOUCHSCREEN_ADAPTIVE_ICNL9911X_SPI)
 ...
 */
//#define CFG_CTS_HANDLE_IRQ_USE_KTHREAD //binhua
...
#define CFG_CTS_FIRMWARE_IN_FS
    ...
    #define CFG_CTS_FIRMWARE_FILEPATH       "/data/local/tmp/ICNL9911C.bin"//"/etc/firmware/ICNL9911C.bin"
...
#include "ats_cts_plat_qcom_config.h"

#ifdef CONFIG_CTS_SPI_HOST
#ifndef CFG_CTS_HAS_RESET_PIN
@error("SPI bus MUST has reset pin")
#endif
