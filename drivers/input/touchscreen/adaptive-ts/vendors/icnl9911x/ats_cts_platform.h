...
#define cts_err(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_ERROR, "[TS]<E>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_warn(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_WARN,  "[TS]<W>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_info(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_INFO,  "[TS]<I>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
#define cts_dbg(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_DEBUG, "[TS]<D>CTS-" LOG_TAG " " fmt"\n", ##__VA_ARGS__)
