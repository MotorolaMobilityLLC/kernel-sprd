...
/* BEGIN Ontim, yangyuxiang, 11/11/2020, 9987208, St-result:PASS, update icnl9911c-easyquick self test function. */
...
/* BEGIN Ontim, yangyuxiang, 11/11/2020, 9987208, St-result:PASS, update icnl9911c-truly self test function. */
        if (dump_test_date_to_file) {
