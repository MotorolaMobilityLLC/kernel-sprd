...
#define VIRTUAL_I2C_DEVICETREE_NAME		"virtualsar,antcheck"	// Must match device tree .compatible string exactly
...
static const char *sar_name = "antcheck";
static const char *sar_input_phys = "input/antcheck";
