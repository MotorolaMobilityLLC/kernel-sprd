...
#define ISP_SCALER_PRE_CFG                            (0xC010UL)
#define ISP_SCALER_PRE_TRIM1_SIZE                     (0xC034UL)

/*isp sub block: SCALER    VID*/
#define ISP_SCALER_VID_STATUS0                        (0xD000UL)
#define ISP_SCALER_VID_CFG                            (0xD010UL)
#define ISP_SCALER_VID_TRIM1_SIZE                     (0xD034UL)
...
/*isp sub block: THUMBNAIL_SCALER*/
...
/*used for store_out, store_Pre_Cap, store_Vid and store_Thumb*/
...
#define ISP_ARBITER_CHK_SUM1                          (0x0468UL)
#define ISP_ARBITER_CHK_SUM2                          (0x046cUL)
#define ISP_ARBITER_CHK_SUM3                          (0x0470UL)
#define ISP_ARBITER_CHK_SUM4                          (0x0474UL)
#define ISP_ARBITER_CHK_SUM5                          (0x0478UL)
#define ISP_ARBITER_CHK_SUM6                          (0x047cUL)
#define ISP_ARBITER_CHK_SUM7                          (0x0480UL)
#define ISP_ARBITER_CHK_SUM8                          (0x0484UL)
#define ISP_ARBITER_CHK_SUM9                          (0x0488UL)
#define ISP_ARBITER_CHK_SUM10                         (0x048cUL)
#define ISP_ARBITER_CHK_SUM11                         (0x0490UL)
#define ISP_ARBITER_CHK_SUM12                         (0x0494UL)

/*isp sub block: axi*/
#define ISP_AXI_WR_MASTER_STATUS                      (0x0500UL)
#define ISP_AXI_RD_MASTER_STATUS                      (0x0504UL)
#define ISP_AXI_TIMER_STATUS                          (0x0508UL)
...
#define ISP_AXI_CACHE_ACTIVE                          (0x0530UL)
#define ISP_AXI_CHK_SUM_CTRL                          (0x0534UL)
#define ISP_AXI_STATUS0                               (0x0538UL)
#define ISP_AXI_STATUS1                               (0x053CUL)
#define ISP_AXI_STATUS2                               (0x0540UL)
#define ISP_AXI_STATUS3                               (0x0544UL)
...
#define ISP_FMCU_RESERVED                             (0xF038UL)
#define ISP_FMCU_SW_TRIGGER                           (0xF03CUL)

/*fmcu0 & fmcu1 both use 0xF030*/
...
#define ISP_FMCU1_RESERVED                            (0xF138UL)
...
/*isp sub block:3dnr*/
#define ISP_3DNR_BASE                                 (0x9000UL)
#define ISP_3DNR_START                                (0x0010UL)
#define ISP_3DNR_END                                  (0x0050UL)

#define ISP_3DNR_BLEND_BASE                           (0x9100UL)
#define ISP_3DNR_BLEND_START                          (0x0010UL)
#define ISP_3DNR_BLEND_END                            (0x0070UL)

#define ISP_3DNR_STORE_BASE                           (0x9200UL)
#define ISP_3DNR_STORE_START                          (0x0010UL)
#define ISP_3DNR_STORE_END                            (0x0024UL)

#define ISP_3DNR_CROP_BASE                            (0x9300UL)
#define ISP_3DNR_CROP_START                           (0x0010UL)
#define ISP_3DNR_CROP_END                             (0x001CUL)
...
#define ISP_NLM_RADIAL_1D_ADDBACK01                   (0x2154UL)
#define ISP_NLM_RADIAL_1D_ADDBACK02                   (0x2158UL)
#define ISP_NLM_RADIAL_1D_ADDBACK03                   (0x215CUL)
#define ISP_NLM_RADIAL_1D_ADDBACK10                   (0x2160UL)
#define ISP_NLM_RADIAL_1D_ADDBACK11                   (0x2164UL)
#define ISP_NLM_RADIAL_1D_ADDBACK12                   (0x2168UL)
#define ISP_NLM_RADIAL_1D_ADDBACK13                   (0x216CUL)
#define ISP_NLM_RADIAL_1D_ADDBACK20                   (0x2170UL)
#define ISP_NLM_RADIAL_1D_ADDBACK21                   (0x2174UL)
#define ISP_NLM_RADIAL_1D_ADDBACK22                   (0x2178UL)
#define ISP_NLM_RADIAL_1D_ADDBACK23                   (0x217CUL)
...
#define ISP_CFAE_CSS_CFG0                             (0x302CUL)//need delete
#define ISP_CFAE_CSS_CFG1                             (0x3030UL)//need delete
#define ISP_CFAE_CSS_CFG2                             (0x3034UL)//need delete
#define ISP_CFAE_CSS_CFG3                             (0x3038UL)//need delete
#define ISP_CFAE_CSS_CFG4                             (0x303CUL)//need delete
#define ISP_CFAE_CSS_CFG5                             (0x3040UL)//need delete
#define ISP_CFAE_CSS_CFG6                             (0x3044UL)//need delete
#define ISP_CFAE_CSS_CFG7                             (0x3048UL)//need delete
#define ISP_CFAE_CSS_CFG8                             (0x304CUL)//need delete
#define ISP_CFAE_CSS_CFG9                             (0x3050UL)//need delete
#define ISP_CFAE_CSS_CFG10                            (0x3054UL)//need delete
#define ISP_CFAE_CSS_CFG11                            (0x3058UL)//need delete
#define ISP_CFAE_GBUF_CFG                             (0x305CUL)//need delete
...
#define ISP_RGBG_YRANDOM_PARAM1                       (0x5E10UL)
#define ISP_RGBG_YRANDOM_PARAM2                       (0x5E14UL)
#define ISP_RGBG_YRANDOM_PARAM3                       (0x5E18UL)
#define ISP_RGBG_YRANDOM_INIT                         (0x5E24UL)
...
#define ISP_BRIGHT_STATUS                             (0x5200UL)//need delete
#define ISP_BRIGHT_PARAM                              (0x5210UL)//need delete

/*isp sub block: Contrast*/
#define ISP_CONTRAST_STATUS                           (0x5300UL)//need delete
#define ISP_CONTRAST_PARAM                            (0x5310UL)//need delete

/*isp sub block: csa*/
#define ISP_CSA_STATUS                                (0x5800UL) //need delete
#define ISP_CSA_PARAM                                 (0x5810UL)//need delete

/*isp sub block: hua*/
#define ISP_HUA_STATUS                                (0x5900UL)//need delete
#define ISP_HUA_PARAM                                 (0x5910UL)//need delete

/*isp sub block: HIST :    histogram*/
#define ISP_HIST_STATUS                               (0x3700UL)//need delete
#define ISP_HIST_PARAM                                (0x3710UL)//need delete
#define ISP_HIST_ROI_START                            (0x3714UL)//need delete
#define ISP_HIST_ROI_END                              (0x3718UL)//need delete
#define ISP_HIST_CFG_READY                            (0x371CUL)//need delete
#define ISP_HIST_SKIP_NUM_CLR                         (0x3720UL)//need delete
#define ISP_HIST_BUF0_CH0                             (0x15000UL)//need delete
...
#define ISP_HIST_CH0                                  (0x15000UL)//need delete
