...
#define BIT_AON_APB_FORCE_CSI0_PHY_SHUTDOWNZ BIT(1)
#define BIT_AON_APB_MIPI_PHY1_PS_PD_L	BIT(10)
#define BIT_AON_APB_MIPI_PHY1_PS_PD_S	BIT(11)
#define BIT_AON_APB_MIPI_PHY0_PS_PD_L	BIT(12)
#define BIT_AON_APB_MIPI_PHY0_PS_PD_S	BIT(13)
#define BIT_AON_APB_FORCE_CSI1_PHY_SHUTDOWNZ BIT(20)
...
#define BIT_MM_AHB_CSI0_SOFT_RST	BIT(5)
#define BIT_MM_AHB_CSI1_SOFT_RST	BIT(10)
#define BIT_MM_AHB_CSI_IDI_SW_SOFT_RST BIT(11)

#define BIT_MM_AHB_MIPI_CPHY_SEL	BIT(0)
#define BIT_MM_AHB_FORCE_SWITCH		BIT(0)
...
void csi_idi_switch(struct csi_phy_info *phy, unsigned int phy_id);
