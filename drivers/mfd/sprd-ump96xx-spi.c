...
static const struct spi_device_id sprd_pmic_spi_ids[] = {
	{ .name = "ump9620", .driver_data = (unsigned long)&pmic_ump9620_matrix },
	{ .name = "ump9621", .driver_data = (unsigned long)&pmic_ump9621_matrix },
	{ .name = "ump9622", .driver_data = (unsigned long)&pmic_ump9622_matrix },
	{},
};
