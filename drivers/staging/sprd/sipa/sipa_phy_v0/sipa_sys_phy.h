...
static inline u32 sipa_sys_phy_module_soft_rst(
...
static inline u32 sipa_sys_phy_module_enable(
	void __iomem *reg_base,
	u32 sys)
{
	u32 tmp;
	...
	tmp |= sys;
	writel_relaxed(tmp,
				   reg_base + IPA_SYS_AHB_ENABLE);

	return TRUE;
}

static inline u32 sipa_sys_phy_module_disable(
	void __iomem *reg_base,
	u32 sys)
{
	u32 tmp;
