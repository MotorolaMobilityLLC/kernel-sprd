...
#define SIPA_FIFO_USB_UL	0x80l /*PAM_U3 -> IPA*/
#define SIPA_FIFO_SDIO_UL	0x100l
#define SIPA_FIFO_AP_IP_UL	0x180l/*AP -> IPA*/
#define SIPA_FIFO_PCIE_UL	0x200l
	/* UL PCIE 0 ~ 3*/
#define SIPA_FIFO_REMOTE_PCIE_CTRL0_UL	0x280l
#define SIPA_FIFO_REMOTE_PCIE_CTRL1_UL	0x300l
#define SIPA_FIFO_REMOTE_PCIE_CTRL2_UL	0x380l
#define SIPA_FIFO_REMOTE_PCIE_CTRL3_UL	0x400l
#define SIPA_FIFO_AP_ETH_DL	0x480l/*ap_dev -> IPA*/
	/* DL mAP PCIE 0 ~ 3*/
#define SIPA_FIFO_LOCAL_PCIE_CTRL0_DL	0x500l
#define SIPA_FIFO_LOCAL_PCIE_CTRL1_DL	0x580l
#define SIPA_FIFO_LOCAL_PCIE_CTRL2_DL	0x600l
#define SIPA_FIFO_LOCAL_PCIE_CTRL3_DL	0x680l
#define SIPA_FIFO_WIFI_UL		0x700l
#define SIPA_FIFO_CP_DL	0x780l/*PAM_IPA -> IPA*/
#define SIPA_FIFO_USB_DL	0x800l/*IPA -> PAM_U3*/
#define SIPA_FIFO_SDIO_DL	0x880l
#define SIPA_FIFO_AP_IP_DL	0x900l/*IPA -> AP*/
#define SIPA_FIFO_PCIE_DL		0x980l
	/* DL PCIE 0 ~ 3*/
#define SIPA_FIFO_REMOTE_PCIE_CTRL0_DL	0xA00l
#define SIPA_FIFO_REMOTE_PCIE_CTRL1_DL	0xA80l
#define SIPA_FIFO_REMOTE_PCIE_CTRL2_DL	0xB00l
#define SIPA_FIFO_REMOTE_PCIE_CTRL3_DL	0xB80l
#define SIPA_FIFO_AP_ETH_UL	0xC00l/*IPA -> ap_dev*/
	/* UL mAP PCIE 0 ~ 3*/
#define SIPA_FIFO_LOCAL_PCIE_CTRL0_UL	0xC80l
#define SIPA_FIFO_LOCAL_PCIE_CTRL1_UL	0xD00l
#define SIPA_FIFO_LOCAL_PCIE_CTRL2_UL	0xD80l
#define SIPA_FIFO_LOCAL_PCIE_CTRL3_UL	0xE00l
#define SIPA_FIFO_WIFI_DL		0xE80l
#define SIPA_FIFO_CP_UL		0xF00l/*IPA -> PAM_IPA*/
#define SIPA_CACHE_LINE_CTRL_AND_STS	0xF80
/*Common fifo reg*/
...
#define IPA_TXFIFO_INT_THRESHOLD_ONESHOT_EN	(1l << 11)
#define IPA_TXFIFO_INT_THRESHOLD_SW_EN		(1l << 10)
#define IPA_TXFIFO_INT_DELAY_TIMER_SW_EN	(1l << 9)
#define IPA_TXFIFO_FULL_INT_EN				(1l << 8)
#define IPA_TXFIFO_OVERFLOW_EN				(1l << 7)
#define IPA_ERRORCODE_IN_TX_FIFO_EN			(1l << 6)
...
#define IPA_TX_FIFO_INTR_SW_BIT_EN			(1l << 2)
#define IPA_TX_FIFO_THRESHOLD_EN			(1l << 1)
#define IPA_TX_FIFO_DELAY_TIMER_EN			(1l << 0)
#define IPA_INT_EN_BIT_GROUP				0x00000FFFl

/*Fifo interrupt status bit*/
#define IPA_INT_TX_FIFO_THRESHOLD_SW_STS	(1l << 22)
#define IPA_INT_EXIT_FLOW_CTRL_STS			(1l << 20)
#define IPA_INT_ENTER_FLOW_CTRL_STS			(1l << 19)
#define IPA_INT_TXFIFO_FULL_INT_STS			(1l << 18)
#define IPA_INT_TXFIFO_OVERFLOW_STS			(1l << 17)
#define IPA_INT_ERRORCODE_IN_TX_FIFO_STS	(1l << 16)
#define IPA_INT_INTR_BIT_STS				(1l << 15)
#define IPA_INT_THRESHOLD_STS				(1l << 14)
#define IPA_INT_DELAY_TIMER_STS				(1l << 13)
#define IPA_INT_DROP_PACKT_OCCUR			(1l << 12)
#define IPA_INT_INT_STS_GROUP				0x5FF000l

/*Fifo interrupt clear bit*/
#define IPA_TX_FIFO_TIMER_CLR_BIT			(1l << 0)
#define IPA_TX_FIFO_THRESHOLD_CLR_BIT		(1l << 1)
#define IPA_TX_FIFO_INTR_CLR_BIT			(1l << 2)
#define IPA_ENTRY_FLOW_CONTROL_CLR_BIT		(1l << 3)
#define IPA_EXIT_FLOW_CONTROL_CLR_BIT		(1l << 4)
#define IPA_DROP_PACKET_INTR_CLR_BIT		(1l << 5)
#define IPA_ERROR_CODE_INTR_CLR_BIT			(1l << 6)
#define IPA_TX_FIFO_OVERFLOW_CLR_BIT		(1l << 7)
#define IPA_TX_FIFO_FULL_INT_CLR_BIT		(1l << 8)
 ...
 * Note:
 */
static inline u32 ipa_phy_set_rx_fifo_total_depth(
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_total_depth(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_filled_depth(
	void __iomem *fifo_base)
{
	u32 tmp;

	tmp = readl_relaxed(fifo_base +
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_full_status(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_update_rx_fifo_wptr(
	void __iomem *fifo_base,
	u32 wptr)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_wptr(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_update_rx_fifo_rptr(
	void __iomem *fifo_base,
	u32 rptr)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_empty_status(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_total_depth(
	void __iomem *fifo_base,
	u32 depth)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_total_depth(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_filled_depth(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_full_status(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_empty_status(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_update_tx_fifo_wptr(
	void __iomem *fifo_base,
	u32 wptr)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_wptr(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_update_tx_fifo_rptr(
	void __iomem *fifo_base,
	u32 rptr)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_rptr(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_rx_fifo_addr(
	void __iomem *fifo_base,
	u32 addr_l, u32 addr_h)
{
	u32 tmp_l, tmp_h;

	writel_relaxed(addr_l,
				   fifo_base + IPA_COMMON_RX_FIFO_ADDRL);
	writel_relaxed(addr_h,
				   fifo_base + IPA_COMMON_RX_FIFO_ADDRH);

	tmp_l = readl_relaxed(fifo_base +
						  IPA_COMMON_RX_FIFO_ADDRL);
	tmp_h = readl_relaxed(fifo_base +
 ...
 * Note:
 */
static inline void ipa_phy_get_rx_fifo_addr(
	void __iomem *fifo_base,
	u32 *addr_l, u32 *addr_h)
{
	*addr_l = readl_relaxed(fifo_base +
							IPA_COMMON_RX_FIFO_ADDRL);
	*addr_h = readl_relaxed(fifo_base +
							IPA_COMMON_RX_FIFO_ADDRH);
}
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_addr(
	void __iomem *fifo_base,
	u32 addr_l, u32 addr_h)
{
	u32 tmp_l, tmp_h;
	...
	writel_relaxed(addr_l,
				   fifo_base + IPA_COMMON_TX_FIFO_ADDRL);
	writel_relaxed(addr_h,
				   fifo_base + IPA_COMMON_TX_FIFO_ADDRH);
 ...
 * Note:
 */
static inline void ipa_phy_get_tx_fifo_addr(
	void __iomem *fifo_base,
	u32 *addr_l, u32 *addr_h)
{
	*addr_l = readl_relaxed(fifo_base +
 ...
 * Note:
**/
static inline u32 ipa_phy_enable_int_bit(
	void __iomem *fifo_base,
	u32 int_bit)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_disable_int_bit(
	void __iomem *fifo_base,
	u32 int_bit)
{
	u32 tmp = 0;
...
static inline u32 ipa_phy_get_all_intr_enable_status(
	void __iomem *fifo_base)
{
	u32 tmp = 0;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_fifo_int_sts(
	void __iomem *fifo_base,
	u32 sts)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_fifo_all_int_sts(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline void ipa_phy_clear_int(
	void __iomem *fifo_base,
	u32 clr_bit)
{
	writel_relaxed(clr_bit, fifo_base +
				   IPA_INT_GEN_CTL_CLR);
}
 ...
 * Note:
 */
static inline u32 ipa_phy_get_drop_packet_cnt(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_interrupt_threshold(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_interrupt_threshold(
	void __iomem *fifo_base, u32 threshold)
{
	u32 tmp = 0;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_interrupt_delay_timer(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_interrupt_delay_timer(
	void __iomem *fifo_base, u32 threshold)
{
	u32 tmp = 0;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_cur_term_num(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_cur_term_num(
	void __iomem *fifo_base,
	u32 num)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_dst_term_num(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_dst_term_num(
	void __iomem *fifo_base,
	u32 num)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_prefetch_fifo_priority(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_prefetch_fifo_priority(
	void __iomem *fifo_base,
	u32 pri)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_prefetch_threshold(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_prefetch_threshold(
	void __iomem *fifo_base,
	u32 threshold)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_stop_receive(
	void __iomem *fifo_base)
{
	u32 tmp;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_clear_stop_receive(
	void __iomem *fifo_base)
{
	u32 tmp = 0;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_flow_ctrl_recover(
	void __iomem *fifo_base)
{
	u32 tmp = 0;
	void __iomem *fifo_reg_addr;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_flow_ctrl_config(
	void __iomem *fifo_base,
	u32 config)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_flow_ctrl_config(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_exit_flow_ctrl_watermark(
	void __iomem *fifo_base,
	u32 watermark)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_exit_flow_ctrl_watermark(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_tx_fifo_entry_flow_ctrl_watermark(
	void __iomem *fifo_base,
	u32 watermark)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_tx_fifo_entry_flow_ctrl_watermark(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_rx_fifo_exit_flow_ctrl_watermark(
	void __iomem *fifo_base,
	u32 watermark)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_exit_flow_ctrl_watermark(
	void __iomem *fifo_base)
{
	u32 tmp;
 ...
 * Note:
 */
static inline u32 ipa_phy_set_rx_fifo_entry_flow_ctrl_watermark(
	void __iomem *fifo_base,
	u32 watermark)
{
	u32 tmp = 0;
 ...
 * Note:
 */
static inline u32 ipa_phy_get_rx_fifo_entry_flow_ctrl_watermark(
	void __iomem *fifo_base)
{
	u32 tmp;
