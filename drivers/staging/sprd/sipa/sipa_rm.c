...
static const char *resource_name_to_str[SIPA_RM_RES_MAX] = {
	...
	__stringify(SIPA_RM_RES_CONS_AP_CP),
	__stringify(SIPA_RM_RES_CONS_AP_EXT_CP),
	__stringify(SIPA_RM_RES_CONS_AP_WIFI),
	__stringify(SIPA_RM_RES_CONS_AP_USB),
	__stringify(SIPA_RM_RES_CONS_USB_CP),
	__stringify(SIPA_RM_RES_CONS_WIFI_CP),
	__stringify(SIPA_RM_RES_CONS_VOWIFI_CP),
	__stringify(SIPA_RM_RES_CONS_AP_CTRL0),
	__stringify(SIPA_RM_RES_CONS_AP_CTRL1),
	__stringify(SIPA_RM_RES_CONS_AP_CTRL2),
	__stringify(SIPA_RM_RES_CONS_AP_CTRL3),
	__stringify(SIPA_RM_RES_CONS_CP_CTRL0),
	__stringify(SIPA_RM_RES_CONS_CP_CTRL1),
	__stringify(SIPA_RM_RES_CONS_CP_CTRL2),
	__stringify(SIPA_RM_RES_CONS_CP_CTRL3),
};
