	...
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_UL_CP_FREE_FIFO_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_UL_CP_FREE_FIFO_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_UL_CP_FILLED_FIFO_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_UL_CP_FILLED_FIFO_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_init_pcie_dl_fifo_base(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_DL_CP_FREE_FIFO_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_DL_CP_FREE_FIFO_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_DL_CP_FILLED_FIFO_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_DL_CP_FILLED_FIFO_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_init_wiap_ul_fifo_base(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_UL_AP_FREE_FIFO_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_UL_AP_FREE_FIFO_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_UL_AP_FILLED_FIFO_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_UL_AP_FILLED_FIFO_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_init_wiap_dl_fifo_base(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_DL_AP_FREE_FIFO_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_DL_AP_FREE_FIFO_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_DL_AP_FILLED_FIFO_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_DL_AP_FILLED_FIFO_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_pcie_ul_fifo_sts_addr(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_UL_CP_FREE_STS_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_UL_CP_FREE_STS_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_UL_CP_FILLED_STS_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_UL_CP_FILLED_STS_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_pcie_dl_fifo_sts_addr(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_DL_CP_FREE_STS_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_DL_CP_FREE_STS_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_DL_CP_FILLED_STS_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_DL_CP_FILLED_STS_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_wiap_ul_fifo_sts_addr(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_UL_AP_FREE_STS_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_UL_AP_FREE_STS_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_UL_AP_FILLED_STS_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_UL_AP_FILLED_STS_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_wiap_dl_fifo_sts_addr(
	void __iomem *reg_base,
	u32 free_addrl, u32 free_addrh,
	u32 filled_addrl, u32 filled_addrh)
{
	__raw_writel(free_addrl,
				 reg_base +
				 PAM_IPA_DL_AP_FREE_STS_BASE_ADDRL);
	__raw_writel(free_addrh,
				 reg_base +
				 PAM_IPA_DL_AP_FREE_STS_BASE_ADDRH);
	__raw_writel(filled_addrl,
				 reg_base +
				 PAM_IPA_DL_AP_FILLED_STS_BASE_ADDRL);
	__raw_writel(filled_addrh,
				 reg_base +
				 PAM_IPA_DL_AP_FILLED_STS_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_ddr_mapping(
	void __iomem *reg_base,
	u32 offset_l, u32 offset_h)
{
	__raw_writel(offset_l,
				 reg_base +
				 PAM_IPA_DDR_MAPPING_OFFSET_L);
	__raw_writel(offset_h,
				 reg_base +
				 PAM_IPA_DDR_MAPPINH_OFFSET_H);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_pcie_rc_base(
	void __iomem *reg_base,
	u32 offset_l, u32 offset_h)
{
	__raw_writel(offset_l,
				 reg_base +
				 PAM_IPA_PCIE_RC_BASE_ADDRL);
	__raw_writel(offset_h,
				 reg_base +
				 PAM_IPA_PCIE_RC_BASE_ADDRH);

	return TRUE;
}

static inline u32 pam_ipa_phy_set_pair1_id(
	void __iomem *reg_base,
	u32 id)
{
	u32 tmp = 0;

	tmp = __raw_readl(reg_base +
					  PAM_IPA_ID_REPLACE_PAIR1);
	tmp &= 0x000000FF;
	tmp |= (id << 8);
	__raw_writel(tmp,
				 reg_base +
...
static inline u32 pam_ipa_phy_set_pair2_id(
	void __iomem *reg_base,
	u32 id)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_set_pair3_id(
	void __iomem *reg_base,
	u32 id)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_set_pair4_id(
	void __iomem *reg_base,
	u32 id)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_set_offset_present(
	void __iomem *reg_base,
	u32 offset)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_start(
	void __iomem *reg_base)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_stop(
	void __iomem *reg_base)
{
	u32 tmp = 0;
...
static inline u32 pam_ipa_phy_resume(
	void __iomem *reg_base,
	u32 flag)
{
	u32 tmp = 0;
