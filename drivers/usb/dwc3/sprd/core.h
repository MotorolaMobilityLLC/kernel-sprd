...
/* prototypes */
void dwc3_sprd_set_prtcap(struct dwc3 *dwc, u32 mode);
void dwc3_sprd_set_mode(struct dwc3 *dwc, u32 mode);
u32 dwc3_sprd_core_fifo_space(struct dwc3_ep *dep, u8 type);
...
bool dwc3_sprd_has_imod(struct dwc3 *dwc);

int dwc3_sprd_event_buffers_setup(struct dwc3 *dwc);
void dwc3_sprd_event_buffers_cleanup(struct dwc3 *dwc);

#if IS_ENABLED(CONFIG_USB_DWC3_HOST) || IS_ENABLED(CONFIG_USB_DWC3_DUAL_ROLE)
int dwc3_sprd_host_init(struct dwc3 *dwc);
void dwc3_sprd_host_exit(struct dwc3 *dwc);
#else
static inline int dwc3_sprd_host_init(struct dwc3 *dwc)
{ return 0; }
static inline void dwc3_sprd_host_exit(struct dwc3 *dwc)
{ }
#endif

#if IS_ENABLED(CONFIG_USB_DWC3_GADGET) || IS_ENABLED(CONFIG_USB_DWC3_DUAL_ROLE)
int dwc3_sprd_gadget_init(struct dwc3 *dwc);
void dwc3_sprd_gadget_exit(struct dwc3 *dwc);
int dwc3_sprd_gadget_set_test_mode(struct dwc3 *dwc, int mode);
int dwc3_sprd_gadget_get_link_state(struct dwc3 *dwc);
int dwc3_sprd_gadget_set_link_state(struct dwc3 *dwc, enum dwc3_link_state state);
int dwc3_sprd_send_gadget_ep_cmd(struct dwc3_ep *dep, unsigned cmd,
		struct dwc3_gadget_ep_cmd_params *params);
int dwc3_sprd_send_gadget_generic_command(struct dwc3 *dwc, unsigned cmd, u32 param);
#else
static inline int dwc3_sprd_gadget_init(struct dwc3 *dwc)
{ return 0; }
static inline void dwc3_sprd_gadget_exit(struct dwc3 *dwc)
{ }
static inline int dwc3_sprd_gadget_set_test_mode(struct dwc3 *dwc, int mode)
{ return 0; }
static inline int dwc3_sprd_gadget_get_link_state(struct dwc3 *dwc)
{ return 0; }
static inline int dwc3_sprd_gadget_set_link_state(struct dwc3 *dwc,
		enum dwc3_link_state state)
{ return 0; }

static inline int dwc3_sprd_send_gadget_ep_cmd(struct dwc3_ep *dep, unsigned cmd,
		struct dwc3_gadget_ep_cmd_params *params)
{ return 0; }
static inline int dwc3_sprd_send_gadget_generic_command(struct dwc3 *dwc,
		int cmd, u32 param)
{ return 0; }
#endif

#if IS_ENABLED(CONFIG_USB_DWC3_DUAL_ROLE)
int dwc3_sprd_drd_init(struct dwc3 *dwc);
void dwc3_sprd_drd_exit(struct dwc3 *dwc);
void dwc3_sprd_otg_init(struct dwc3 *dwc);
void dwc3_sprd_otg_exit(struct dwc3 *dwc);
void dwc3_sprd_otg_update(struct dwc3 *dwc, bool ignore_idstatus);
void dwc3_sprd_otg_host_init(struct dwc3 *dwc);
#else
static inline int dwc3_sprd_drd_init(struct dwc3 *dwc)
{ return 0; }
static inline void dwc3_sprd_drd_exit(struct dwc3 *dwc)
{ }
static inline void dwc3_sprd_otg_init(struct dwc3 *dwc)
{ }
static inline void dwc3_sprd_otg_exit(struct dwc3 *dwc)
{ }
static inline void dwc3_sprd_otg_update(struct dwc3 *dwc, bool ignore_idstatus)
{ }
static inline void dwc3_sprd_otg_host_init(struct dwc3 *dwc)
{ }
#endif

/* power management interface */
#if !IS_ENABLED(CONFIG_USB_DWC3_HOST)
int dwc3_sprd_gadget_suspend(struct dwc3 *dwc);
int dwc3_sprd_gadget_resume(struct dwc3 *dwc);
void dwc3_sprd_gadget_process_pending_events(struct dwc3 *dwc);
#else
static inline int dwc3_sprd_gadget_suspend(struct dwc3 *dwc)
{
	return 0;
}

static inline int dwc3_sprd_gadget_resume(struct dwc3 *dwc)
{
	return 0;
}

static inline void dwc3_sprd_gadget_process_pending_events(struct dwc3 *dwc)
{
}
#endif /* !IS_ENABLED(CONFIG_USB_DWC3_HOST) */

#if IS_ENABLED(CONFIG_USB_DWC3_ULPI)
int dwc3_sprd_ulpi_init(struct dwc3 *dwc);
void dwc3_sprd_ulpi_exit(struct dwc3 *dwc);
#else
static inline int dwc3_sprd_ulpi_init(struct dwc3 *dwc)
{ return 0; }
static inline void dwc3_sprd_ulpi_exit(struct dwc3 *dwc)
{ }
#endif
