...
static irqreturn_t dwc3_otg_thread_irq(int irq, void *_dwc)
{
	...
	dwc3_sprd_set_mode(dwc, DWC3_GCTL_PRTCAP_OTG);
...
void dwc3_sprd_otg_init(struct dwc3 *dwc)
{
	...
	dwc3_sprd_set_prtcap(dwc, DWC3_GCTL_PRTCAP_OTG);
