...
extern void dwc3_sprd_debugfs_create_endpoint_dir(struct dwc3_ep *dep);
extern void dwc3_sprd_debugfs_init(struct dwc3 *);
extern void dwc3_sprd_debugfs_exit(struct dwc3 *);
#else
static inline void dwc3_sprd_debugfs_create_endpoint_dir(struct dwc3_ep *dep)
{  }
static inline void dwc3_sprd_debugfs_init(struct dwc3 *d)
{  }
static inline void dwc3_sprd_debugfs_exit(struct dwc3 *d)
{  }
#endif
