...
#define TUNEHSAMP_VALUE	  (0x3 << 25)
#define TFREGRES_VALUE	  (0x2 << 19)
#define TFHSRES_VALUE	  (0x14 << 14)
#define TUNERISE_VALUE	  (0x1 << 12)
#define TUNEDSC_VALUE     (0x1 << 7)
#define TUNESQ_VALUE      (0x8 << 3)
...
static int sprd_hsphy_init(struct usb_phy *x)
{
	...
	msk = MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TUNEHSAMP |
		MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TFREGRES |
		MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TFHSRES |
		MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TUNERISE |
		MASK_ANLG_PHY_G2_ANALOG_USB20_USB20_TUNEDSC |
