...
static struct musb_fifo_cfg sprd_musb_device_mode_cfg_single[] = {
	...
	MUSB_EP_FIFO_SINGLE(13, FIFO_TX, 1024),
	MUSB_EP_FIFO_SINGLE(13, FIFO_RX, 1024),
	MUSB_EP_FIFO_SINGLE(14, FIFO_TX, 256),
	MUSB_EP_FIFO_SINGLE(14, FIFO_RX, 256),
	MUSB_EP_FIFO_SINGLE(15, FIFO_TX, 256),
	MUSB_EP_FIFO_SINGLE(15, FIFO_RX, 256),
};
