BSP_KERNEL_ARCH="arm"
BSP_KERNEL_DIFF_CONFIG_ARCH="sprd-diffconfig/sharkle/$BSP_KERNEL_ARCH"
BSP_KERNEL_DIFF_CONFIG_COMMON="sprd-diffconfig/sharkle/common"
