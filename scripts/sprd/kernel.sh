...
{
	make_config
	make -C $BSP_KERNEL_PATH O=$BSP_KERNEL_OUT $BSP_CC_LD_ARG ARCH=$BSP_KERNEL_ARCH CROSS_COMPILE=$BSP_KERNEL_CROSS_COMPILE -j$BSP_OBJ
	compile_check $?
...
{
	make -C $BSP_KERNEL_PATH O=$BSP_KERNEL_OUT $BSP_CC_LD_ARG ARCH=$BSP_KERNEL_ARCH CROSS_COMPILE=$BSP_KERNEL_CROSS_COMPILE $BSP_KERNEL_DEFCONFIG -j$BSP_OBJ
	compile_check $?
...
{
	make -C $BSP_KERNEL_PATH O=$BSP_KERNEL_OUT $BSP_CC_LD_ARG ARCH=$BSP_KERNEL_ARCH CROSS_COMPILE=$BSP_KERNEL_CROSS_COMPILE $BSP_KERNEL_DEFCONFIG menuconfig -j$BSP_OBJ
	compile_check $?
...
function make_dtb()
{
	make -C $BSP_KERNEL_PATH O=$BSP_KERNEL_OUT $BSP_CC_LD_ARG ARCH=$BSP_KERNEL_ARCH CROSS_COMPILE=$BSP_KERNEL_CROSS_COMPILE dtbs -j$BSP_OBJ
	compile_check $?
...
function make_clean()
{
	make -C $BSP_KERNEL_PATH O=$BSP_KERNEL_OUT $BSP_CC_LD_ARG ARCH=$BSP_KERNEL_ARCH CROSS_COMPILE=$BSP_KERNEL_CROSS_COMPILE mrproper -j$BSP_OBJ
	compile_check $?
}
